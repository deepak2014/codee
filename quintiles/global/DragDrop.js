...
(function() {
		...
		*/
		...
		this.buildInitialArray= function(){
			...
			console.log(dragDrop.draggableCount+" buildInitialArray "+liCount);
		...
		this.updateOnChangeOfPosition = function(liElementId, oldIndex, newIndex){
			...
			if($("#pageContainer").attr("data-pagename")=="cra_dragndrop_v1.html"){
				if(dragDrop.questionAnswer<3){
			...
			//dragDrop.enableSubmitAndMarkAsChanged(liElementId);			
			//dragDrop.swapArrayElement(oldIndex, newIndex);
			console.log(" dragDrop.attemptMaidForDD "+dragDrop.attemptMaidForDD);
		}
		...
		//alert($("#pageContainer").attr("data-pagename"));
