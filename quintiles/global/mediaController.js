...
(function() {
    ...
    this.showCustomAnimation = function(mediaPlayer) {
		//
		if (customAnimationArray != "undefined" && customAnimationArray != undefined){
        ...
        if (attributeType === 'image') {
			...
			if (customAnimationArray != "undefined" && customAnimationArray != undefined){
				if (customAnimationArray[mediaController.timeArrayCounter].time == inputTimeArray[mediaController.timeArrayCounter]) {
					...
					//console.log(customAnimationArray[mediaController.timeArrayCounter].show1);
		...
		if (customAnimationArray != "undefined" && customAnimationArray != undefined){
			for (var i = 0; i < customAnimationArray.length; i++) {
				if (newCurrent <= customAnimationArray[i].time) { // Closing the future popups
					...
					if ($('#page').hasClass('customAnimationTemplate') || $('#pageContainer').attr('data-templateid') === 'cra_animationplayer_v1'
					|| $('#pageContainer').attr('data-templateid') === 'cra_animationplayer_v2' || $('#pageContainer').attr('data-templateid') === 'cra_animationplayer_v3' 
						 || $('#pageContainer').attr('data-templateid') === 'q1_animationplayer_v11_2' 
						  || $('#branchPageContainer').attr('data-pagename') == 'm1_02_06.html' ) {
